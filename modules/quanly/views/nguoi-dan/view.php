    ...
    <div class="col-lg-12">
        <div class="block block-rounded row g-0">
            ...
            <li class="nav-item d-md-flex flex-md-column" role="presentation">
                <button class="nav-link text-md-start active" id="thongtinchung-tab" data-bs-toggle="tab" data-bs-target="#thongtinchung" role="tab" aria-controls="thongtinchung" aria-selected="false" tabindex="-1">
                <i class="fa fa-fw fa-user-circle opacity-50 me-1 d-none d-sm-inline-block"></i> Thông tin công dân
                </button>
            </li>
            <li class="nav-item d-md-flex flex-md-column" role="presentation">
                <button class="nav-link text-md-start" id="thongtincutru-tab" data-bs-toggle="tab" data-bs-target="#thongtincutru" role="tab" aria-controls="thongtincutru" aria-selected="true">
            ...
            <div class="tab-content col-md-9">
                <div class="block-content tab-pane active show" id="thongtinchung" role="tabpanel" aria-labelledby="thongtinchung-tab" tabindex="0">
                    <div class="row">
                        <div class="col-lg-12">
                            <table class="table table-bordered">
                                <tr>
                                    <th style="width:35%">Địa chỉ nóc gia</th>
                                    <td><?= ($model->hogiadinh_id != null) ? $model->hogiadinh->nocgia->so_nha.', '.$model->hogiadinh->nocgia->ten_duong.', '.$model->hogiadinh->nocgia->khupho->TenKhuPho.', '.$model->hogiadinh->nocgia->phuongxa->tenXa : ''?></td>
                                </tr>
                ...
                <div class="block-content tab-pane" id="thongtincutru" role="tabpanel" aria-labelledby="thongtincutru-tab" tabindex="0">
