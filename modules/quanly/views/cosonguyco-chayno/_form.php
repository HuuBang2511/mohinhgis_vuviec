...
<div class="block block-themed">
    ...
    <div class="block-content">
        ...
        <div class="row mt-3">
            ...
            <div class="col-lg-6">
                <?= $form->field($model, 'loai_hinh')->textInput(['maxlength' => true]) ?>
            </div>
            <div class="col-lg-6">
                <?= $form->field($model, 'muc_do_nguy_co')->textInput(['maxlength' => true]) ?>
            </div>
            <div class="col-lg-6">
                <?= $form->field($model, 'don_vi_quan_ly')->textInput(['maxlength' => true]) ?>
            </div>
        </div>
