    ...
    <div class="col-lg-12">
        <div class="block block-themed">
            <div class="block-header">
                <h3 class="block-title">Import thông tin bảng dữ liêu</h3>
            ...
            <div class="block-content">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <?= $form->field($fileUpload, 'table')->widget(Select2::className(), [
                                'data' => [
                                    'CosonguycoChayno' => 'Cơ sở nguy cơ cháy nổ',
                                    'DiemNhayCam' => 'Điểm nhạy cảm',
                                    'MuctieuTrongdiem' => 'Mục tiêu trọng điểm',
                                    'TruNuocCcc' => 'Trụ nước PCCC',
                                    'KhuvucPhuctapAnNinh' => 'Khu vực an ninh phức tạp',
                                    'CameraAnNinh' => 'Camera an ninh',
                                    'ChotTuantre' => 'Chốt tuần tra',
                                    'CosokinhdoanhCodk' => 'Cơ sở kinh doanh có điều kiện',
                                    'DiemNhayCam' => 'Điểm nhạy cảm',
                                    'DiemTenannxh' => 'Điểm tệ nạn xã hội',
                                    'DiemTrongDiem' => 'Điểm trọng điểm',
                                    'MuctieuTrongdiem' => 'Mục tiêu trọng điểm',
