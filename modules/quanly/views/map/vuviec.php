...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const layerConfig = [
        ...
        { id: 'wmsBothusongLayer', wmsName: 'gis_camau:camau_bts', displayName: 'Trạm BTS', defaultVisible: false, zIndex: 550, popupFields: { 'Doanh_nghiep': 'Doanh nghiệp', 'Ma_tram_BTS' : 'Mã trạm bộ thu sóng', 'Dia_chi_lap_dat' : 'Địa chỉ lắp đặt', 'Do_cao_cot_ang_ten (m)' : 'Độ cao cột ăng ten', 'Dien_tich_dat_su_dung (m²)' : 'Diện tích đất sử dụng (m²)', 'Ten_ca_nhan_to_chuc_so_huu_cot_ang_ten' : 'Tên cá nhân tổ chức sở hữu cột ăng ten', 'Ten_don_vi_su_dung_chung' : 'Tên đơn vị sử dụng chung', 'Cot_ang_ten_kien_co_chiu_duoc_rui_ro_thien_tai_cap_IV (Co/Khong' : 'Cột ăng ten có chịu được rủi ro thiên tai cấp IV' } },
        { id: 'wmsThuyheLayer', wmsName: 'gis_camau:camau_thuyhe', displayName: 'Thủy hệ', defaultVisible: false, zIndex: 550, popupFields: { 'ten_kenh_rach': 'Tên', 'chieu_dai': 'Dài (m)', 'ti_le':'Tỉ lệ', 'xa': 'Tên ĐVHC' } },
