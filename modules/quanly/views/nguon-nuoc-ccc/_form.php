...
<div class="block block-themed">
    ...
    <div class="block-content">
        <div class="row mt-3">
            <div class="col-lg-4">
                <?= $form->field($model, 'ten_nguon')->textInput(['maxlength' => true]) ?>
            </div>
            <div class="col-lg-4">
                <?= $form->field($model, 'loai_nguon')->textInput(['maxlength' => true]) ?>
            </div>
            <div class="col-lg-4">
                <?= $form->field($model, 'dung_tich_m3')->textInput(['maxlength' => true]) ?>
            </div>
            <div class="col-lg-4">
