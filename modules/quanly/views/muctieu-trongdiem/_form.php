...
<div class="block block-themed">
    ...
    <div class="block-content">
        <div class="row mt-3">
            ...
            <div class="col-lg-4">
                <?= $form->field($model, 'loai_muctieu')->textInput(['maxlength' => true]) ?>
            </div>
            <div class="col-lg-4">
                <?= $form->field($model, 'cap_quanly')->textInput(['maxlength' => true]) ?>
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-lg-12">
        ...
        <div class="row mt-3">
            <div class="col-lg-12">
                <?= $form->field($model, 'trang_thai_an_ninh')->textInput(['maxlength' => true]) ?>
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-lg-12">
                <?= $form->field($model, 'mo_ta')->textArea(['rows' => 3]) ?>
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-lg-6">
