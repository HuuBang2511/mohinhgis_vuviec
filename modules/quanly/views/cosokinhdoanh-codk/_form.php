...
<div class="block block-themed">
    ...
    <div class="block-content">
        <div class="row mt-3">
            ...
            <div class="row mt-3">
                <div class="col-lg-4">
                    <?= $form->field($model, 'ten_co_so')->textInput(['maxlength' => true]) ?>
                </div>
                <div class="col-lg-4">
                    <?= $form->field($model, 'loai_hinh_kinh_doanh')->textInput(['maxlength' => true]) ?>
                </div>
                <div class="col-lg-4">
                    <?= $form->field($model, 'trang_thai_hoat_dong')->textInput(['maxlength' => true]) ?>
                </div>
            </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-3">
                    <?= $form->field($model, 'giay_phep_so')->textInput(['maxlength' => true]) ?>
                </div>
                <div class="col-lg-3">
                    <?= $form->field($model, 'ngay_cap')->widget(MaskedInput::className(), [
                        'clientOptions' => [
                            'alias' => 'date'
                        ],
                    ]); ?>
