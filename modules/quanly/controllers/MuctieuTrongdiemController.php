...
use app\modules\quanly\models\MuctieuTrongdiemSearch;
...
/**
 * MuctieuTrongdiemController implements the CRUD actions for MuctieuTrongdiem model.
 */
class MuctieuTrongdiemController extends \app\modules\quanly\base\QuanlyBaseController
{

    public $title = "Mục tiêu trọng điểm";

    /**
     * Lists all MuctieuTrongdiem models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new MuctieuTrongdiemSearch();
    ...
    /**
     * Displays a single MuctieuTrongdiem model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new MuctieuTrongdiem model.
        ...
        if($model->load($request->post()) && $model->save() && $filedinhkem->load($request->post())){
            ...
            if($filedinhkem->fileupload != null){
                ...
                foreach($filedinhkem->fileupload as $i => $item){
                    ...
                    $file[] = 'uploads/muctieu-trongdiem/'.$model->id.'/'.$item->baseName.'.'.$item->extension;
                    $path = 'uploads/muctieu-trongdiem/'.$model->id.'/';
    ...
    /**
     * Updates an existing MuctieuTrongdiem model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing MuctieuTrongdiem model.
     * For ajax request will return json object
    ...
    /**
     * Finds the MuctieuTrongdiem model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return MuctieuTrongdiem the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = MuctieuTrongdiem::findOne($id)) !== null) {
            return $model;
        } else {
