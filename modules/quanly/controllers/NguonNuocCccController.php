...
use app\modules\quanly\models\NguonNuocCccSearch;
...
/**
 * NguonNuocCccController implements the CRUD actions for NguonNuocCcc model.
 */
class NguonNuocCccController extends \app\modules\quanly\base\QuanlyBaseController
{

    public $title = "Nguồn nước PCCC";

    /**
     * Lists all NguonNuocCcc models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new NguonNuocCccSearch();
    ...
    /**
     * Displays a single NguonNuocCcc model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new NguonNuocCcc model.
        ...
        if($model->load($request->post()) && $model->save() && $filedinhkem->load($request->post())){
            ...
            if($filedinhkem->fileupload != null){
                ...
                foreach($filedinhkem->fileupload as $i => $item){
                    ...
                    $file[] = 'uploads/nguonnuocpccc/'.$model->id.'/'.$item->baseName.'.'.$item->extension;
                    $path = 'uploads/nguonnuocpccc/'.$model->id.'/';
    ...
    /**
     * Updates an existing NguonNuocCcc model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing NguonNuocCcc model.
     * For ajax request will return json object
    ...
    /**
     * Finds the NguonNuocCcc model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return NguonNuocCcc the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = NguonNuocCcc::findOne($id)) !== null) {
            return $model;
        } else {
