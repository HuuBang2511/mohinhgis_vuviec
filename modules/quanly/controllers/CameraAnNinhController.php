...
use app\modules\quanly\models\CameraAnNinhSearch;
...
/**
 * CameraAnNinhController implements the CRUD actions for CameraAnNinh model.
 */
class CameraAnNinhController extends \app\modules\quanly\base\QuanlyBaseController
{

    public $title = "Camera An Ninh";

    /**
     * Lists all CameraAnNinh models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new CameraAnNinhSearch();
    ...
    /**
     * Displays a single CameraAnNinh model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CameraAnNinh model.
        ...
        if($model->load($request->post()) && $model->save() && $filedinhkem->load($request->post())){
            ...
            if($filedinhkem->fileupload != null){
                ...
                foreach($filedinhkem->fileupload as $i => $item){
                    ...
                    $file[] = 'uploads/camera-anninh/'.$model->id.'/'.$item->baseName.'.'.$item->extension;
                    $path = 'uploads/camera-anninh/'.$model->id.'/';
    ...
    /**
     * Updates an existing CameraAnNinh model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing CameraAnNinh model.
     * For ajax request will return json object
    ...
    /**
     * Finds the CameraAnNinh model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CameraAnNinh the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = CameraAnNinh::findOne($id)) !== null) {
            return $model;
        } else {
