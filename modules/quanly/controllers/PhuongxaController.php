...
use app\modules\quanly\models\PhuongxaSearch;
 ...
 */
class PhuongxaController extends \app\modules\quanly\base\QuanlyBaseController
{
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Thêm mới Phuongxa",
                    'content'=>'<span class="text-success">Thêm mới Phuongxa thành công</span>',
                    'footer'=> Html::button('Đóng',['class'=>'btn btn-light float-right','data-bs-dismiss'=>"modal"]).
                            Html::a('Tiếp tục thêm mới',['create'],['class'=>'btn btn-primary float-left','role'=>'modal-remote'])
                ];
            }else{
                return [
                    'title'=> "Create new Phuongxa",
                    'content'=>$this->renderAjax('create', [
                        'model' => $model,
                    ]),
                    'footer'=> Html::button('Đóng',['class'=>'btn btn-light float-right','data-bs-dismiss'=>"modal"]).
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->maXa]);
            } else {
    ...
    /**
     * Delete an existing Phuongxa model.
     * For ajax request will return json object
