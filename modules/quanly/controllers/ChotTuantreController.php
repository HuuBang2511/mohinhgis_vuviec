...
use app\modules\quanly\models\ChotTuantreSearch;
...
/**
 * ChotTuantreController implements the CRUD actions for ChotTuantre model.
 */
class ChotTuantreController extends \app\modules\quanly\base\QuanlyBaseController
{

    public $title = "Chốt tuần tra";

    /**
     * Lists all ChotTuantre models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new ChotTuantreSearch();
    ...
    /**
     * Displays a single ChotTuantre model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new ChotTuantre model.
        ...
        if($model->load($request->post()) && $model->save() && $filedinhkem->load($request->post())){
            ...
            if($filedinhkem->fileupload != null){
                ...
                foreach($filedinhkem->fileupload as $i => $item){
                    ...
                    $file[] = 'uploads/chottuantra/'.$model->id.'/'.$item->baseName.'.'.$item->extension;
                    $path = 'uploads/chottuantra/'.$model->id.'/';
    ...
    /**
     * Updates an existing ChotTuantre model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing ChotTuantre model.
     * For ajax request will return json object
    ...
    /**
     * Finds the ChotTuantre model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ChotTuantre the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = ChotTuantre::findOne($id)) !== null) {
            return $model;
        } else {
