...
/**
 * DiemTrongDiemSearch represents the model behind the search form about `app\modules\quanly\models\DiemTrongDiem`.
 */
class DiemTrongDiemSearch extends DiemTrongDiem
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = DiemTrongDiem::find()->where(['status' => 1]);
