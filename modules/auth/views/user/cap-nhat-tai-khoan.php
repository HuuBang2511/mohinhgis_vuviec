...
$this->title = 'Cập nhật người dùng: ' . $model->fullname;
        ...
        <div class="block block-themed">
            ...
            <div class="block-content padding-tb-05">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <?= $form->field($model, 'nguoidan_id')->widget(Select2::className(), [
                                ...
                                'options' => ['placeholder' => 'Tìm kiếm người dân ...', 'id' => 'chonnguoidan_id'],
                                'pluginOptions' => [
                                    'allowClear' => true,
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="form-check ">
                                    <input class="form-check-input" type="checkbox" value="<?= $role['id'] ?>"
                                        name="roles[]" <?= in_array($role['id'], $userGroups) ? 'checked' : '' ?>>
                ...
                <div class="form-group">
                    ...
                    <a href="<?= Url::to(['index']) ?>" class="btn btn-light float-end"><i class="fa fa-arrow-left"></i>
                        Quay lại</a>
                </div>
                <?php } ?>
